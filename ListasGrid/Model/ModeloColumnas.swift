...
class ModeloColumnas: ObservableObject {
    /*Paso 1.2 ,usamos el published porque se ocupara en otro lados
    ...
    func columnas(num : Int){
        ...
        /*
         ...
         V-100,Paso 2.0 UserDefaults-Guardamos un registro en un valor, se guarda en la memoria
         y así hacemos la persistencia de datos.
    ...
    */
    init(){
        ...
        if let num = UserDefaults.standard.object(forKey: "numero") as? Int {
            ...
            //Le damos el número por defecto que es uno por si no hay nada guardado aún.
